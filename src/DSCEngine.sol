 ...
 * @author Garv
 *
 * This system is designed to be as minimal as possible, and have the tokens maintain a 1DSC = 1$ peg.
...
contract DSCEngine is ReentrancyGuard {
     ...
     * @param tokenCollateralAddress The address of the token to deposit as collateral
     * @param amountCollateral The amount of collateral to deposit
     * @param amountDSCToMint The amount of the decntralized stablecoin to mint
     ...
     * @param tokenCollateralAddress The address of the token to deposit as collateral
     * @param amountCollateral The amount of collateral to deposit
     * @param amountDSCToBurn The amount of the decntralized stablecoin to mint
     ...
     * @param debtToCover the amount of DSC you need to burn to improve the users health factor.
    ...
    /////////////
    function getTokenAmountFromUSD(address token, uint256 tokenAmountInWei) public view returns (uint256) {
        AggregatorV3Interface priceFeed = AggregatorV3Interface(s_priceFeeds[token]);
        (, int256 price,,,) = priceFeed.staleCheckLatestRoundData();
        return (tokenAmountInWei * PRECISION) / (uint256(price) * ADDITIONAL_FEED_PRECISION);
    }
